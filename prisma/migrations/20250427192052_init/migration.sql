...
-- CreateIndex
CREATE UNIQUE INDEX "TripDestination_trip_id_destination_id_key" ON "TripDestination"("trip_id", "destination_id");
...
-- AddForeignKey
ALTER TABLE "TripDestination" ADD CONSTRAINT "TripDestination_trip_id_fkey" FOREIGN KEY ("trip_id") REFERENCES "Trip"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "TripDestination" ADD CONSTRAINT "TripDestination_destination_id_fkey" FOREIGN KEY ("destination_id") REFERENCES "Destination"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
