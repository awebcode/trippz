...
exports.config = {
    ...
    database: {
        url: process.env.DATABASE_URL || "postgresql://postgres:postgres@127.0.0.1:5432/trippz",
    },
    // JWT Configuration
    jwt: {
        ...
        resetPasswordSecret: process.env.JWT_RESET_PASSWORD_SECRET || "your_jwt_reset_password_secret",
        emailVerificationSecret: process.env.JWT_EMAIL_VERIFICATION_SECRET || "your_jwt_email_verification_secret",
        phoneVerificationSecret: process.env.JWT_PHONE_VERIFICATION_SECRET || "your_jwt_phone_verification_secret",
    },
    ...
    oauth: {
        google: {
            ...
            clientSecret: process.env.GOOGLE_CLIENT_SECRET || "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",
        },
        facebook: {
