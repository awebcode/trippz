    ...
    try {
      ...
      const updatedFlight = await prisma.flight.update({
        ...
        data: {
          ...
          departure_time: data.departure_time ? new Date(data.departure_time) : flight.departure_time,
          arrival_time: data.arrival_time ? new Date(data.arrival_time) : flight.arrival_time,
