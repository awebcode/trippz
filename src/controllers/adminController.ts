...
import type { AnalyticsQuery, SystemSettingsInput, UpdateUserRoleInput, UserQuery } from "../validators/adminValidators"
...
export class AdminController {
  ...
  static getAnalytics = catchAsync(async (req: Request, res: Response, next: NextFunction) => {
  ...
  // System Settings
  static getSystemSettings = catchAsync(async (req: Request, res: Response, next: NextFunction) => {
  ...
  static updateSystemSettings = catchAsync(async (req: Request, res: Response, next: NextFunction) => {
